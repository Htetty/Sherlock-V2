// The investigation pipeline: clone -> sandbox -> reproduction plan ->
// deterministic execution -> verified fix loop -> pull request. Extracted
// from the HTTP route so the queue worker can run it directly; both the
// Express route and the BullMQ worker call this single implementation.
...
import { validateReproductionPlan } from "./plan.js";
import {
  createArtifactStore,
